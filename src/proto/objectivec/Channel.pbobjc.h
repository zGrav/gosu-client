...
@class Channel;
@class ChannelReadStatusResponseEntry;
@class ChannelUser;
@class Game;
...
/// Test to see if @c latestMessage has been set.
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<ChannelReadStatusResponseEntry*> *channelsArray;
...
/// Test to see if @c banDuration has been set.
...
/// Fetches the raw value of a @c ChannelCreateGroupChannelRequest's @c type property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t ChannelCreateGroupChannelRequest_Type_RawValue(ChannelCreateGroupChannelRequest *message);
/// Sets the raw value of an @c ChannelCreateGroupChannelRequest's @c type property, allowing
...
/// Fetches the raw value of a @c ChannelInviteMemberResponse's @c error property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t ChannelInviteMemberResponse_Error_RawValue(ChannelInviteMemberResponse *message);
/// Sets the raw value of an @c ChannelInviteMemberResponse's @c error property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
...
/// Fetches the raw value of a @c RPCJoinProprietaryChannelsRequest's @c type property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t RPCJoinProprietaryChannelsRequest_Type_RawValue(RPCJoinProprietaryChannelsRequest *message);
/// Sets the raw value of an @c RPCJoinProprietaryChannelsRequest's @c type property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
...
/// Fetches the raw value of a @c RPCChannelCreateGroupChannelRequest's @c type property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t RPCChannelCreateGroupChannelRequest_Type_RawValue(RPCChannelCreateGroupChannelRequest *message);
/// Sets the raw value of an @c RPCChannelCreateGroupChannelRequest's @c type property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
...
/// Fetches the raw value of a @c RPCChannelCreateChannelRequest's @c type property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t RPCChannelCreateChannelRequest_Type_RawValue(RPCChannelCreateChannelRequest *message);
/// Sets the raw value of an @c RPCChannelCreateChannelRequest's @c type property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
...
/// Fetches the raw value of a @c ChannelUpdateResponse's @c error property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t ChannelUpdateResponse_Error_RawValue(ChannelUpdateResponse *message);
/// Sets the raw value of an @c ChannelUpdateResponse's @c error property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
...
typedef GPB_ENUM(RPCChannelAddUsersToHubChannelRequest_FieldNumber) {
  ...
  RPCChannelAddUsersToHubChannelRequest_FieldNumber_PublishProfilePullRequests = 5,
};
...
@property(nonatomic, readwrite) BOOL publishProfilePullRequests;
...
typedef GPB_ENUM(RPCChannelAddUsersToHubChannelResponse_FieldNumber) {
  ...
  RPCChannelAddUsersToHubChannelResponse_FieldNumber_ProcessedUserIdsArray = 2,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSString*> *processedUserIdsArray;
/// The number of items in @c processedUserIdsArray without causing the array to be created.
@property(nonatomic, readonly) NSUInteger processedUserIdsArray_Count;

@end

/// Fetches the raw value of a @c RPCChannelAddUsersToHubChannelResponse's @c error property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t RPCChannelAddUsersToHubChannelResponse_Error_RawValue(RPCChannelAddUsersToHubChannelResponse *message);
/// Sets the raw value of an @c RPCChannelAddUsersToHubChannelResponse's @c error property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
...
/// Fetches the raw value of a @c RPCChannelAddUserToHubChannelsResponse's @c error property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t RPCChannelAddUserToHubChannelsResponse_Error_RawValue(RPCChannelAddUserToHubChannelsResponse *message);
/// Sets the raw value of an @c RPCChannelAddUserToHubChannelsResponse's @c error property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
...
/// Fetches the raw value of a @c RPCChannelInviteMemberResponse's @c error property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t RPCChannelInviteMemberResponse_Error_RawValue(RPCChannelInviteMemberResponse *message);
/// Sets the raw value of an @c RPCChannelInviteMemberResponse's @c error property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
